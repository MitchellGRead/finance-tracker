...
Here is official documentation about best practices for skills: https://docs.claude.com/en/docs/agents-and-tools/agent-skills/best-practices
...
```bash
tsx scripts/init_skill.ts <skill-name> --path <output-directory>
```
...
```bash
tsx scripts/package_skill.ts <path/to/skill-folder>
```

Optional output directory specification:

```bash
tsx scripts/package_skill.ts <path/to/skill-folder> ./dist
```
